...
def _gen_deploys():
    return [{"id":"deploy-4471","service":"fraud-engine","version":"2.14.0-rc3","description":"Updated fraud rule: lowered velocity threshold from 8 to 3 txns/min for high-risk MCCs","deployed_by":"sarah.chen@bank.internal","timestamp":DEPLOY_TIME.isoformat(),"status":"completed","change_ticket":"CHG-8834"},{"id":"deploy-4470","service":"card-auth-service","version":"5.2.1","description":"Routine dependency bump no logic changes","deployed_by":"ci-pipeline","timestamp":(DEPLOY_TIME - timedelta(hours=3, minutes=17)).isoformat(),"status":"completed","change_ticket":"CHG-8820"},{"id":"deploy-4469","service":"mobile-app","version":"4.17.0","description":"UI polish for card management screen","deployed_by":"ci-pipeline","timestamp":(DEPLOY_TIME - timedelta(hours=7, minutes=52)).isoformat(),"status":"completed","change_ticket":"CHG-8815"}]
